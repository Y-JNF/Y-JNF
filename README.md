...
- 💻 Currently focusing on learning and improving my skills in **C++**.  
- 🚀 Passionate about building practical projects and enhancing my programming experience.  

## 🛠️ Skills
- 🔹 **C++** (currently specializing and deepening knowledge)  
...
## 🎯 Goals
- ✅ Achieve an advanced level in **C++**.  
- ✅ Expand later into other languages such as Python and JavaScript.  
